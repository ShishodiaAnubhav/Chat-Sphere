...
class SignUpActivity : AppCompatActivity() {
    ...
    fun updateSignUpUI(firebaseUser: FirebaseUser?, username: String) {
        if(firebaseUser != null) {
            val imageUrl = "https://firebasestorage.googleapis.com/v0/b/chat-sphere-64660.appspot.com/o/account_circle.png?alt=media&token=0b0e9b94-5a64-4f74-8528-9bc3c6a667dc"
